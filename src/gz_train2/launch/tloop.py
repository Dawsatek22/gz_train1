...
def generate_launch_description():
    ...
    gazebo_basics_pkg = get_package_share_directory('gz_train2')
    ...
    urdf_rviz = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'gz_train2',
            'urdf_package_path': PathJoinSubstitution([gazebo_basics_pkg,'urdf', 'test_urdf']),
    ...
    sub = Node(package='gz_train2',
                    namespace='sleepnode'
                    ,executable='gz_sub',
                    remappings=[('/loop', '/sleep_sub')],
                    name='pubsleep',
                     output='screen')
    
    
    pub = Node(package='gz_train2',
                    namespace='sleepnode'
                    ,executable='lpub',
                    remappings=[('/loop', '/keyboard/keypress')],
                    name='pubsleep',
                     output='screen')
   ...
   ,
    ...
    launchDescriptionObject.add_action(pub)
    launchDescriptionObject.add_action(sub)
