...
ros_gz_interfaces__msg__Contacts__get_type_hash(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0x2c, 0xf3, 0x6d, 0xd5, 0x1e, 0x10, 0x55, 0x80,
      0x83, 0x9f, 0xb7, 0xd6, 0xc0, 0x28, 0x84, 0x6a,
      0x63, 0x42, 0xa8, 0xdf, 0xd6, 0x2f, 0xde, 0x73,
      0x3d, 0x05, 0xf3, 0xe0, 0xc9, 0xec, 0x4b, 0x5b,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t ros_gz_interfaces__msg__Contact__EXPECTED_HASH = {1, {
...
static char ros_gz_interfaces__msg__Contacts__TYPE_NAME[] = "ros_gz_interfaces/msg/Contacts";
...
static char ros_gz_interfaces__msg__Contacts__FIELD_NAME__header[] = "header";
static char ros_gz_interfaces__msg__Contacts__FIELD_NAME__contacts[] = "contacts";

static rosidl_runtime_c__type_description__Field ros_gz_interfaces__msg__Contacts__FIELDS[] = {
  {
    {ros_gz_interfaces__msg__Contacts__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {ros_gz_interfaces__msg__Contacts__FIELD_NAME__contacts, 8, 8},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ros_gz_interfaces__msg__Contacts__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
ros_gz_interfaces__msg__Contacts__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {ros_gz_interfaces__msg__Contacts__TYPE_NAME, 30, 30},
      {ros_gz_interfaces__msg__Contacts__FIELDS, 2, 2},
    },
    {ros_gz_interfaces__msg__Contacts__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&ros_gz_interfaces__msg__Contact__EXPECTED_HASH, ros_gz_interfaces__msg__Contact__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[3].fields = ros_gz_interfaces__msg__Contact__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[5].fields = ros_gz_interfaces__msg__JointWrench__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[8].fields = std_msgs__msg__UInt32__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
ros_gz_interfaces__msg__Contacts__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
ros_gz_interfaces__msg__Contacts__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ros_gz_interfaces__msg__Contacts__get_individual_type_description_source(NULL),
    ...
    sources[4] = *ros_gz_interfaces__msg__Contact__get_individual_type_description_source(NULL);
    sources[5] = *ros_gz_interfaces__msg__Entity__get_individual_type_description_source(NULL);
    sources[6] = *ros_gz_interfaces__msg__JointWrench__get_individual_type_description_source(NULL);
    sources[7] = *std_msgs__msg__Header__get_individual_type_description_source(NULL);
    sources[8] = *std_msgs__msg__String__get_individual_type_description_source(NULL);
    sources[9] = *std_msgs__msg__UInt32__get_individual_type_description_source(NULL);
    constructed = true;
  }
