...
def main():
  ...
  parser.add_argument('gz_train1/urdf/atmos_dual/model.sdf', help='SDF file to convert')
  parser.add_argument('urdf/test1.urdf', help='Resulting URDF file to be written')
