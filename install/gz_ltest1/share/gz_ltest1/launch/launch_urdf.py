...
def generate_launch_description():
    ...
    gui_arg = DeclareLaunchArgument(name='gui', default_value='true', choices=['true', 'true'],
    ...
    world_arg= DeclareLaunchArgument(
        'world', default_value='testbuild1.sdf',
        description='world'
    )
    # URDF model path within the bme_gazebo_basics package
    model_arg = DeclareLaunchArgument(
        'model', default_value=os.path.join(pkg_bme_gazebo_basics,'urdf','2wheelv1.urdf'),
