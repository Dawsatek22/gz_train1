...
def generate_launch_description():
    ...
    gazebo_basics_pkg = get_package_share_directory('gz_trainpy')
    ...
    joy = Node(package='gz_trainpy',
                    namespace='evdev_pub'
                    ,executable='evpub',
                   remappings=[('/topic', '/joy')],
                    name='pubjoy',
                     output='screen')
    ...
    arguments=['/topic@std_msgs/msg/Int32@gz.msgs.Int32'],
    remappings=[('/topic', '/joy')],
    output='screen'
   ,
        parameters=[
